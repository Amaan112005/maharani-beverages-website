...
CSS_FILES = ["assets/css/variables.css", "assets/css/main.css", "assets/css/mobile-perfection.css?v=1.1"]
JS_FILES = ["assets/js/aos.js", "assets/js/main.js"]
...
CRITICAL_CSS = """
:root{--color-primary:#040916;--color-bg:#060b1a;--color-accent:#b59e6d;--color-muted:rgba(255,255,255,0.65);--font-heading:'Syne',sans-serif;--font-body:'DM Sans',sans-serif}
...
.header{position:fixed;top:0;left:0;width:100%;z-index:1000;background:rgba(4,9,22,0.9);backdrop-filter:blur(10px);border-bottom:1px solid rgba(255,255,255,0.06)}
  ...
  <header class="header">
    <nav class="container" aria-label="Primary navigation">
      <div style="display:flex;align-items:center;gap:1rem;">
        <a href="/">
          <img src="{logo_path}" alt="{brand_short} Official Logo" class="logo" width="80" height="66" loading="lazy">
        </a>
      </div>
    ...
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:3rem;margin-bottom:3rem;">
        ...
        <div style="grid-column:span 1;">
          <a href="/">
            <img src="{logo_path}" alt="{brand_short} Official Logo" loading="lazy" width="120" height="99">
          </a>
